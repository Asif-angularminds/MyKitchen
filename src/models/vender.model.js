...
venderSchema.plugin(softDelete);
venderSchema.plugin(private);
venderSchema.plugin(paginate);
 ...
 */
venderSchema.statics.isEmailTaken = async function (email, excludeUserId) {
 ...
 * @returns {Promise<boolean>}
 */
venderSchema.methods.isPasswordMatch = async function (password) {
          const user = this;
